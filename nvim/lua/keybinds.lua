...
vim.api.nvim_set_keymap('n', '<leader>wn', "<C-w>n:Explore .<CR>", {})
vim.api.nvim_set_keymap('n', '<leader>wv', "<C-w>v:Explore .<CR>", {})
...
vim.api.nvim_set_keymap('n', '<C-_>', ":call nerdcommenter#Comment('n', 'Toggle')<CR>", {})
vim.api.nvim_set_keymap('v', '<C-_>', ":call nerdcommenter#Comment('x', 'Toggle')<CR>", {})
-- For neovide
...
vim.api.nvim_set_keymap('n', '<C-s>', ':lua vim.lsp.buf.signature_help()<CR>', { noremap = true, silent = true })
